...
const deletePost = async () => {
  try {
    const response = await fetch(`https://api.reparv.in/salesapp/post/deletepost/${post.postId}`, {
      method: 'DELETE',
       headers: {
 ...
 <EllipsisVertical size={18} />
  ...
  <Text style={styles.noImageText}>No image selected</Text>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity onPress={()=>setVisible(false)} style={[styles.button,{backgroundColor:'gray'}]}>
              <Text style={styles.buttonText}>Cancel</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={updatePost} style={[styles.button, styles.save]}>
