  ...
  return (
    <View style={{flex: 1, top: -100, backgroundColor: 'white'}}>
      <LinearGradient
        ...
        <View
          style={[styles.gradientBox]} // Use a solid color as the background
        >
          <View
            style={{
              width: '95%',
            ...
            <View style={styles.Textcontainer}>
              <Text style={styles.text}>
                Get <Text style={{fontWeight: 800}}>₹500</Text> for each
                referral
              </Text>
            </View>
            <View
          ...
          <View
            ...
            <View
              ...
              <Text style={styles.shareText}>
                Share the Reparv App with your friends or family who are
                interested in joining as a Sales Partner.
              </Text>
            ...
            <View
              ...
              <Text style={styles.shareText}>
                Your friend or family member signs up and completes their
                onboarding process.
              </Text>
              <View style={styles.line}></View>
            </View>
            ...
            <View
              ...
              {/* Vector (assuming you're using a view or icon placeholder here) */}
              ...
              <Text style={styles.shareText}>
                Earn ₹500 when they successfully join as a Sales Partner!
              </Text>
            </View>
          </View>
        </View>
